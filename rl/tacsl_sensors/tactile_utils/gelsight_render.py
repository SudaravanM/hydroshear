...
conf_r15 = {
    ...
    # 'background_path': os.path.join(gelsight_path, "gelsight_r15_data/mmint_bg.jpg"),
...
conf_gs_mini = {
    'background_path': os.path.join(gelsight_path, "gs_mini_data/mmint_gs_mini_2D9C-N227_07072025_bg_R_no_dots.png"),
    # 'background_path': os.path.join(gelsight_path, "gs_mini_data/bg.jpg"),
    # 'background_path': os.path.join(gelsight_path, "gs_mini_data/mmint_bg.jpg"),
...
class gelsightRender:
    ...
    def render_tensorized(self, heightMap):
        ...
        sim_img_rgb_tensor = torch.zeros((*idx_x_tensor.shape, 3), device=self.device)
